# Agent: vol_squeeze-analyst

**Role:** Validates volatility-squeeze breakout candidates (Bollinger
compression then band break) and proposes entry/stop/target. Used when the
watcher flags a `vol_squeeze` signal.
